...
export declare const Responses: {
    readonly tankBuster: (targetSev?: "info" | "alert" | "alarm" | undefined, otherSev?: "info" | "alert" | "alarm" | undefined) => (data: unknown, _: unknown, output: Output) => TargetedResponseOutput;
    readonly tankBusterSwap: (busterSev?: "info" | "alert" | "alarm" | undefined, swapSev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
    readonly tankCleave: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
    ...
    readonly stackMarkerOn: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    ...
    readonly knockbackOn: (targetSev?: "info" | "alert" | "alarm" | undefined, otherSev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
    ...
    readonly lookAwayFromTarget: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    readonly lookAwayFromSource: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    ...
    readonly sleep: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    readonly stun: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    readonly interrupt: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    readonly preyOn: (targetSev?: "info" | "alert" | "alarm" | undefined, otherSev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
    readonly awayFrom: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
    ...
    readonly earthshaker: (sev?: "info" | "alert" | "alarm" | undefined) => (data: Data, _: unknown, output: Output) => {
        [x: string]: (data: Data, matches: TargetedMatches, output: Output) => string | undefined;
    };
